...
Modified from open source by Will Carter @willrbc to include custom interface features and semantic-ui
  ...
  render() {
    ...
    return (
      <div
        ...
        <Input loading icon='user' iconPosition='left' {...inputProps} />
...
<PlacesAutocomplete inputProps={props}/>)
